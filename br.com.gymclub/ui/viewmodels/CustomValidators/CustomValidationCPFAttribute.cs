...
namespace ui.viewmodels.CustomValidators
{
        ...
        public class CustomValidationCPFAttribute : ValidationAttribute, IClientModelValidator
    {
...

        {
            if (value == null || string.IsNullOrEmpty(value.ToString()))
                return new ValidationResult("o campo CPF está vazio");
        ...
        public void AddValidation(ClientModelValidationContext context)
        {
            ...
            context.Attributes.Add("data-val-cpf",!string.IsNullOrEmpty(ErrorMessage)
                     ? ErrorMessage
                     : "CPF invalid");
